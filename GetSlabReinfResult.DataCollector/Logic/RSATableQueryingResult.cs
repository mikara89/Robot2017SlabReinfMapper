    ...
    public class RSATableQueryingResult : IRSATableQueryingResult
    {
            ...
            CancellationToken ct)
        {
            ...
            try
            {
                ...
                var t = ConvertCSVtoDataTable(temp/*@"F:/aaaaa.csv"*/);
        ...
        private void GetAllFeFromSlab(int ObjNumber,
            IProgress<ProgressModelObject<double>> progress,
            CancellationToken ct)
        {  
            ...
            t.Select(IRobotSelectionType.I_ST_PANEL, ObjNumber.ToString());
